      ...
      <View style={styles.content}>
        ...
        <View style={styles.contentView}>
          <Text style={styles.messageText}>
            {STRING_CONFIG.imagePickerText.headerOne}
          </Text>
          <Text style={styles.messageSubText}>
            {STRING_CONFIG.imagePickerText.headerTwo}
          </Text>
        </View>
      </View>
      <CustomButton
        btnTitleName={STRING_CONFIG.imagePickerText.ButtonText}
        customStyle={{ marginVertical: verticalScale(8) }}
        // onPress={_handleLoginButton}
      />
      <CustomButton
        btnTitleName={STRING_CONFIG.imagePickerText.tryAgain}
        customStyle={{ marginVertical: verticalScale(8) }}
        // onPress={_handleLoginButton}
      />
    </View>
